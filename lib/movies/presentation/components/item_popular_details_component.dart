...
class ItemPopularDetailsComponent extends StatelessWidget {
  const ItemPopularDetailsComponent({
    super.key,
  });
        ...
        switch (state.popularState) {
                        ...
                        children: [
                          Expanded(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: ApiConstance.imageUrl(movie.backPath),
                              height: 140.0,
                              width: 90,
                              fit: BoxFit.cover,
          ...
          case RequestState.error:
            return Column(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children:  [
                Center(child:Text(state.popularMessage),),
              ],
            );
